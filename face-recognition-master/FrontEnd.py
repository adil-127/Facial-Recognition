...
def register_new_user():
    ...
    while True:
        ...
        # Display the latest caption on the frame
        cv2.putText(frame, 'press button to register the user', (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
...
start_button = ttk.Button(root, text="Start Face Detection", command=start_face_detection)
start_button.pack(pady=20)

register_button = ttk.Button(root, text="Register New User",command=register_new_user)
